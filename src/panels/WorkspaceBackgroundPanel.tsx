...
export function WorkspaceBackgroundPanel(){
  ...
  function color(value:string){change(b=>{b.workspaceBackground=value;b.workspacePattern=undefined;b.workspaceImageId=undefined;});}
